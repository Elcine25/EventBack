...
<li class="breadcrumb-item text-muted">
    <a href="{{route('ville-index')}}" class="text-muted">Liste des villes</a>
</li>
<li class="breadcrumb-item text-dark">{{$ville->name}}</li>
@endsection
@section("css")
        ...
        <div class="col-xl-12">
            ...
            >
                ...
                <div class="card-body py-3">
                    ...
                    <form class="form" method="POST" action="{{route('ville-update', $ville->id)}}" >
                        @method('PUT')
                        @csrf
                        <div>
                            <div class="row w-100">
